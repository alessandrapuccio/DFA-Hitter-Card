...
export default function DeviationSlider({ currentValue, avgValue, stdDev, aboveOrBelowRed, minRange, maxRange, compact = false }) {
  ...
  return (
    <div className={compact ? "p-2 mx-auto" : "p-6 mx-auto"} style={{ maxWidth: '220px' }}>
      <div className={compact ? "text-xs text-gray-600 mb-0.5 text-center" : "text-sm text-gray-600 mb-1 text-center"}>
